...
const std::string LevelManager::QuickSaveFilePath = "Data/quicksave.json";
...
void LevelManager::LoadFile(const std::string& levelFilePath)
{
...
void LevelManager::SaveFile(const std::string& levelFilePath, std::shared_ptr<Environment> environment)
{
    std::ofstream file;
...
void LevelManager::LoadPlayer(Json::Value levelJson)
{
...
void LevelManager::LoadRooms(Json::Value levelJson)
{
...
std::vector<std::shared_ptr<Item>> LevelManager::LoadItems(Json::Value itemsJson)
{
    std::vector<std::shared_ptr<Item>> items;
...
std::shared_ptr<Item> LevelManager::LoadItem(Json::Value itemJson)
{
...
void LevelManager::LoadNonPlayableCharacters(Json::Value levelJson)
{
...
void LevelManager::LoadEnemies(Json::Value levelJson)
{
...
Json::Value LevelManager::SavePlayer(std::shared_ptr<Player> player)
{
...
Json::Value LevelManager::SaveEnemies(std::vector<std::shared_ptr<Enemy>> enemies)
{
...
Json::Value LevelManager::SaveEnemy(std::shared_ptr<Enemy> enemy)
{
...
Json::Value LevelManager::SaveRooms(std::vector<std::shared_ptr<Room>> rooms)
{
...
Json::Value LevelManager::SaveRoom(std::shared_ptr<Room> room)
{
    Json::Value roomJson;
...
Json::Value LevelManager::SaveItems(std::vector<std::shared_ptr<Item>> items)
{
...
Json::Value LevelManager::SaveItem(std::shared_ptr<Item> item)
{
    Json::Value itemJson;
...
Json::Value LevelManager::SaveStatistics(std::vector<std::shared_ptr<Statistic>> statistics)
{
...
Json::Value LevelManager::SaveStatistic(std::shared_ptr<Statistic> statistic)
{
...
Json::Value LevelManager::SaveCoordinates(Coordinates position)
{
