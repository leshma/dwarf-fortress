...
Environment::Environment(Coordinates dimensions, std::vector<std::shared_ptr<Object>> environmentObjects,
...
void Environment::MoveTick(WORD keyPressed)
{
...
std::vector<EnvironmentChange> Environment::MovePlayer(std::shared_ptr<Object>& object,
    std::shared_ptr<Object>& playerObject, int xMovement, int yMovement)
{
    std::vector<EnvironmentChange> changes;
...
std::vector<EnvironmentChange> Environment::MoveEnemies()
{
    std::vector<EnvironmentChange> changes;
...
std::vector<EnvironmentChange> Environment::MoveEnemy(Coordinates& enemyPosition)
{
    std::vector<EnvironmentChange> changes;
