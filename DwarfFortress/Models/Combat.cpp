...
bool Combat::PlayerHitsEnemy(std::shared_ptr<Player>& player, std::shared_ptr<Enemy>& enemy)
{
...
bool Combat::EnemyHitsPlayer(std::shared_ptr<Enemy>& enemy, std::shared_ptr<Player>& player)
{
